  ...
  return (
    <Box variants={container} hidden="hidden" animate="visible">
      ...
      <Title>
        ...
        <Description>
        I love to code, Keep it clean, minimal and simple.
        </Description>
        <Description>
      ...
      <Main variants={item}>
        ...
        <Description>
          I'm passionate about building production ready web apps.
        </Description>
        <Description>
          <strong>Skills</strong>
          <p>React.js, JavaScript, Firebase, NodeJS, Express, MongoDB</p>
          <strong>Tools</strong>
          <p>Netlify, VS Code, npm, Git, Github etc</p>
        </Description>
      </Main>
      <SocialIcons />
