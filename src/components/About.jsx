...
const About = ({ setThemeDark, theme }) => {
  return (
    <Box>
      ...
      <Main>
        <p>
        I'm a Problem Solver and Full-stack developer . I love to code and make simple yet beautiful websites with great user experience.
        </p>
        <p>
        I'm interested in the open-source and full-stack development like trying new things and building great projects.I love to play chess and read books.
        </p>
        <p>
